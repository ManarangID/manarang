			...
			<div class="container">
				<div class="header-row">
					...
					<ul class="menu-container">
							...
							<li class="menu-item">
								<a class="menu-link" href="#"><div><i class="icon-file-alt"></i>Pages</div></a>
								<ul class="sub-menu-container">
								@foreach(getLatestpages(7) as $Latestpages)
									<li class="menu-item">
										<a class="menu-link" href="{{ url('pages/'.$Latestpages->seotitle) }}"><div><i class="icon-stack"></i>{{ $Latestpages->title }}</div></a>
									</li>
								@endforeach
								</ul>
							</li>
							<li class="menu-item">
								<a class="menu-link" href="#"><div><i class="icon-pencil2"></i>News</div></a>
								<ul class="sub-menu-container">
								@foreach(getCategorymenu(7) as $categoryMenu)
									<li class="menu-item">
										<a class="menu-link" href="{{ url('category/'.$categoryMenu->seotitle) }}"><div><i class="icon-newspaper"></i>{{ $categoryMenu->title }}</div></a>
									</li>
								@endforeach
								</ul>
							</li>
