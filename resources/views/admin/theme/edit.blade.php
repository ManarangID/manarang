        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">{{ __('theme.edit_title') }}</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">{{ __('theme.edit_title') }}</h3>
              ...
              <!-- /.card-header -->
            	<!-- form start -->
            	<form id="createForm" method="POST" enctype="multipart/form-data" action="{{ route('themes.update', Hashids::encode($theme->id)) }}">
                @method('PUT')
                @csrf
            	  <div class="card-body">
            		<div class="row">
            		  ...
            		  <div class="col-md-4">
            		    <div class="form-group">
            		      ...
            		      <input type="text" class="form-control" id="author" name="author" value="{{ $theme->author }}" disabled>
            		    </div>
            		    <!-- /.form-group -->
            		  </div>
            		  <!-- /.col -->
            		  <div class="col-md-4">
            		    <div class="form-group">
            		      ...
            		      <select id="active" name="active" class="form-control select2bs4" style="width: 100%;">
							<option value="Y" {{ $theme->active == 'Y' ? 'selected' : '' }}>{{ __('theme.active') }}</option>
							<option value="N" {{ $theme->active == 'N' ? 'selected' : '' }}>{{ __('theme.deactive') }}</option>
						</select>
            		    </div>
            		    <!-- /.form-group -->
            		  </div>
