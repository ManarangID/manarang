          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Create a new posts <small></small></h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" method="POST" enctype="multipart/form-data" action="{{ route('posts.store') }}">
                @csrf
                <div class="card-body">
                @if ($errors->any())
                  ...
                  <div class="row">
                    <div class="col-md-10">
                      ...
                      <div class="form-group">
                        ...
                        <textarea id="summernote" rows="6" name="content">{{ old('content') }}</textarea>
                      </div>
                    </div>
                    <div class="col-md-2">
                      <div class="form-group">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <select class="form-control" id="headline" name="headline">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3" name="picture_description">{{ old('picture_description') }}</textarea>
                      </div>
                    </div>
                  </div>
                </div>
